                ...
                <aside x-show="sidebarOpen"
                    ...
                    <div>
                        ...
                        <div class="flex items-center justify-between mb-10 flex-shrink-0">
                            <div class="flex items-center gap-3 h-10 w-44 text-slate-900 dark:text-white">
                ...
                <header class="flex h-16 items-center justify-between gap-4 mb-8 flex-shrink-0">
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <button @click="toggleDarkMode()" 
                                class="p-2.5 rounded-full bg-slate-100 hover:bg-slate-200 text-slate-600 dark:bg-slate-800 dark:hover:bg-slate-700 dark:text-brand-red-400 transition-all duration-300 transform hover:scale-105 active:scale-95 flex items-center justify-center relative overflow-hidden"
                            ...
                            <svg x-show="darkMode" style="display: none;" class="h-5 w-5 text-brand-red-400 animate-pulse" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20.354 15.354A9 9 0 018.646 3.646 9.003 9.003 0 0012 21a9.003 9.003 0 008.354-5.646z" />
                            </svg>
                        </button>

                        <!-- Public Site link -->
                        <a href="{{ route('home') }}" class="hidden sm:inline-block text-xs font-semibold uppercase tracking-wider text-slate-400 hover:text-brand dark:hover:text-brand-red-400 transition-all">
                            Public Website
                        </a>
