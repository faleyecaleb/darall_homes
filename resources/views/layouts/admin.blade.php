            ...
            <aside class="hidden md:flex md:w-72 md:flex-col bg-white border-r border-slate-100 flex-shrink-0 p-6 justify-between">
                <div>
                    ...
                    <div class="flex items-center gap-3 mb-10">
                        <div class="h-12 w-12 rounded-2xl bg-brand flex items-center justify-center text-white shadow-lg shadow-brand/20 flex-shrink-0">
                            <!-- House Icon -->
                        ...
                        <div class="flex flex-col">
                            <span class="text-xl font-bold tracking-tight text-slate-900 uppercase leading-none">darall</span>
                        ...
                        <div>
                            ...
                            <nav class="space-y-1">
                                ...
                                <a href="{{ route('admin.dashboard') }}" 
                                   class="group flex items-center justify-between px-4 py-3 rounded-2xl transition-all duration-300 {{ request()->routeIs('admin.dashboard') ? 'bg-brand text-white font-semibold shadow-lg shadow-brand/15' : 'text-slate-500 hover:text-slate-900 hover:bg-slate-50' }}">
                                    <div class="flex items-center gap-3">
                                        <!-- Grid icon -->
                                        <svg class="h-5 w-5 flex-shrink-0 transition-transform group-hover:scale-110" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <a href="{{ route('admin.properties.index') }}" 
                                   class="group flex items-center justify-between px-4 py-3 rounded-2xl transition-all duration-300 {{ request()->routeIs('admin.properties.*') ? 'bg-brand text-white font-semibold shadow-lg shadow-brand/15' : 'text-slate-500 hover:text-slate-900 hover:bg-slate-50' }}">
                                    <div class="flex items-center gap-3">
                                        <!-- House icon -->
                                        <svg class="h-5 w-5 flex-shrink-0 transition-transform group-hover:scale-110" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <!-- Categories -->
                                <a href="#" class="group flex items-center justify-between px-4 py-3 rounded-2xl text-slate-500 hover:text-slate-900 hover:bg-slate-50 transition-all duration-300">
                                    <div class="flex items-center gap-3">
                                        <!-- Folder/Tags icon -->
                                        <svg class="h-5 w-5 flex-shrink-0 transition-transform group-hover:scale-110" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <div>
                            ...
                            <nav class="space-y-1">
                                ...
                                <a href="#" class="group flex items-center justify-between px-4 py-3 rounded-2xl text-slate-500 hover:text-slate-900 hover:bg-slate-50 transition-all duration-300">
                                    ...
                                    <span class="px-2 py-0.5 text-[10px] font-bold text-white bg-amber-500 rounded-full">12</span>
                                </a>
                ...
                <div class="flex flex-col gap-1 text-[11px] text-slate-400 border-t border-slate-100 pt-6 px-2">
                    ...
                    <span>Made with 🤍 by Developer</span>
                </div>
            </aside>
