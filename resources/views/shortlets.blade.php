        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="group bg-white rounded-3xl border border-slate-100 overflow-hidden shadow-sm hover:shadow-xl hover:-translate-y-1.5 transition-all duration-300">
                <div class="relative aspect-[4/3] overflow-hidden bg-slate-200">
                    ...
                    <span class="absolute top-4 left-4 bg-brand-red-600 text-white px-3 py-1 rounded-full text-xs font-semibold shadow-md">Shortlet Stays</span>
                    <span class="absolute bottom-4 right-4 bg-slate-950/80 backdrop-blur-sm text-brand-red-400 px-3 py-1.5 rounded-full text-xs font-semibold flex items-center gap-1.5 shadow-md">
                ...
                <div class="p-6 sm:p-8 flex flex-col gap-4">
                    <div class="flex flex-col gap-1.5">
                        ...
                        <h3 class="text-xl font-serif text-slate-900 group-hover:text-brand-red-600 transition-colors">The Zenith Suite</h3>
                    </div>
                    ...
                    <div class="flex justify-between items-center mt-2">
                        ...
                        <a href="{{ route('properties.show', 'the-zenith-suite') }}" class="inline-flex items-center justify-center px-5 py-2.5 text-xs font-semibold text-white bg-slate-950 hover:bg-brand-red-600 rounded-full transition-colors duration-200">
                            Book Stays
                        </a>
                    </div>
                </div>
