            ...
            <div>
                ...
                <nav class="space-y-1">
                    ...
                    <a href="{{ route('admin.categories.index') }}" 
                       class="group flex items-center justify-between px-4 py-3 rounded-2xl transition-all duration-300 hover:translate-x-1.5 {{ request()->routeIs('admin.categories.*') ? 'bg-brand text-white font-semibold shadow-lg shadow-brand/15' : 'text-slate-500 hover:text-slate-900 hover:bg-slate-50' }}">
                        <div class="flex items-center gap-3">
                            <svg class="h-5 w-5 flex-shrink-0 transition-transform group-hover:rotate-12" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <a href="{{ route('admin.locations.index') }}" 
                       class="group flex items-center justify-between px-4 py-3 rounded-2xl transition-all duration-300 hover:translate-x-1.5 {{ request()->routeIs('admin.locations.*') ? 'bg-brand text-white font-semibold shadow-lg shadow-brand/15' : 'text-slate-500 hover:text-slate-900 hover:bg-slate-50' }}">
                        <div class="flex items-center gap-3">
                            <svg class="h-5 w-5 flex-shrink-0 transition-transform group-hover:rotate-12" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <a href="{{ route('admin.amenities.index') }}" 
                       class="group flex items-center justify-between px-4 py-3 rounded-2xl transition-all duration-300 hover:translate-x-1.5 {{ request()->routeIs('admin.amenities.*') ? 'bg-brand text-white font-semibold shadow-lg shadow-brand/15' : 'text-slate-500 hover:text-slate-900 hover:bg-slate-50' }}">
                        <div class="flex items-center gap-3">
                            <svg class="h-5 w-5 flex-shrink-0 transition-transform group-hover:rotate-12" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div>
                ...
                <nav class="space-y-1">
                    ...
                    <a href="{{ route('admin.enquiries.index') }}" 
                       class="group flex items-center justify-between px-4 py-3 rounded-2xl transition-all duration-300 hover:translate-x-1.5 {{ request()->routeIs('admin.enquiries.*') ? 'bg-brand text-white font-semibold shadow-lg shadow-brand/15' : 'text-slate-500 hover:text-slate-900 hover:bg-slate-50' }}">
                        <div class="flex items-center gap-3">
                    ...
                    <a href="{{ route('admin.inspections.index') }}" 
                       class="group flex items-center justify-between px-4 py-3 rounded-2xl transition-all duration-300 hover:translate-x-1.5 {{ request()->routeIs('admin.inspections.*') ? 'bg-brand text-white font-semibold shadow-lg shadow-brand/15' : 'text-slate-500 hover:text-slate-900 hover:bg-slate-50' }}">
                        <div class="flex items-center gap-3">
                            <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
