<div x-data="{ 
    ...
    <!-- 3. Warning Icon -->
    <div x-show="type === 'warning'" style="display: none;" class="h-10 w-10 rounded-full bg-brand-red-500/10 text-brand-red-600 flex items-center justify-center flex-shrink-0">
        <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <div class="flex-1 flex flex-col gap-0.5 overflow-hidden">
        <span class="text-xs font-extrabold uppercase tracking-wider" 
              :class="type === 'success' ? 'text-emerald-600' : (type === 'error' ? 'text-rose-600' : 'text-brand-red-600')"
